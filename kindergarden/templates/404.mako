...
<head>
    ...
    <link rel="shortcut icon" href="${request.static_url('test:static/pyramid-16x16.png')}">

    <title>PyCharm Starter project for the Pyramid Web Framework</title>

    <!-- Bootstrap core CSS -->a
    <link href="//oss.maxcdn.com/libs/twitter-bootstrap/3.0.3/css/bootstrap.min.css" rel="stylesheet">

    <!-- Custom styles for this scaffold -->
    <link href="${request.static_url('test:static/theme.css')}" rel="stylesheet">
...
<div class="starter-template">
    <div class="container">
        <div class="row">
            <div class="col-md-2">
                <img class="logo img-responsive" src="${request.static_url('test:static/pyramid.png')}"
